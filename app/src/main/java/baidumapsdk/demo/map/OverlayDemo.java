...
public class OverlayDemo extends Activity {
    ...
    public void initOverlay() {
        // add marker overlay
        LatLng llA = new LatLng(39.963175, 117.400244);
        LatLng llB = new LatLng(40.942821, 116.369199);
        LatLng llC = new LatLng(39.939723, 115.425541);
        LatLng llD = new LatLng(40.906965, 114.401394);
        ...
        //LatLngBounds build = new LatLngBounds.Builder().include(llA).include(llB).include(llC).include(llD).build();

       // MapStatusUpdate u = MapStatusUpdateFactory.newLatLngBounds(build);
